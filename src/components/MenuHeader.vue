                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li class="smooth-menu"><a href="#team">CLIENTS</a>
                                    </li>
                                    <li class="smooth-menu"><a href="#price">lICENSES</a>
                                    </li>
                                    <li class="smooth-menu"><a href="#news">ABOUT US</a>
                                    </li>
                                    <li class="smooth-menu"><a href="#contact">CONTACT US</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
